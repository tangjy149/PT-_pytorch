...
# print(os.path.join(BASE_DIR, 'meta/class_names.txt'))
...
# g_label2color = {'0': [0, 255, 0], '1': [0, 0, 255], '2': [0, 255, 255], '3': [255, 255, 0], '4': [255, 0, 255],
#                  '5': [100, 100, 255], '6': [200, 200, 100], '7': [170, 120, 200], '8': [255, 0, 0], '9': [200, 100, 100],
#                  '10': [10, 200, 100], '11': [200, 200, 200], 12': [50, 50, 50]}
print(g_class2label)
